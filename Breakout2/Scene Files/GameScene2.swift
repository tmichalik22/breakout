...
class GameScene2: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let backgroundSound = SKAudioNode(fileNamed: "Background-Music-2.wav")
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if score == 24 {
            ...
            if let endOfGame = SKScene(fileNamed: "BoardsScene") {
                self.view?.presentScene(endOfGame, transition: SKTransition.doorsCloseVertical(withDuration: 1.0))
            }
        }
